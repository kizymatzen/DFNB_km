/********************************************************************************************
NAME:    [dbo].[v_top_10_tran_gt]
PURPOSE: Create the [dbo].[v_top_10_tran_gt] view
...
---   ----------  -------   -----------------------------------------------------------------
1.0   7/6/2020  KIZYMATZEN   1. Created the view
...
/****** Object:  View [dbo].[v_top_10_tran_gt]    Script Date: 7/6/2020 2:53:52 PM ******/
DROP VIEW [dbo].[v_top_10_tran_gt]
GO
