/********************************************************************************************
NAME:    [dbo].[v_acct_by_year]
PURPOSE: Create the [dbo].[v_acct_by_year] view
...
EXEC sys.sp_dropextendedproperty @name=N'MS_DiagramPaneCount' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'v_acct_by_year'
GO

EXEC sys.sp_dropextendedproperty @name=N'MS_DiagramPane1' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'v_acct_by_year'
GO

/****** Object:  View [dbo].[v_acct_by_year]    Script Date: 6/16/2020 10:02:52 AM ******/
DROP VIEW [dbo].[v_acct_by_year]
GO
